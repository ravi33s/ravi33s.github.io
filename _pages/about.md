...
I earned my PhD in Computer Science and Engineering from the [Department of Electronics Technology](https://vik.bme.hu/) of the [Budapest University of Technology and Economics](https://www.bme.hu/en) in Budapest, Hungary, under the supervision of [Prof. Dr. Balázs Villányi](https://www.ett.bme.hu/villanyi_balazs/en). My doctoral research was carried out in the [IPAR4 Lab (Industrial Product and Asset Management 4.0 Laboratory)](https://www.ipar4.bme.hu/), where I focused on the integration of [Industrial Internet of Things (IIoT)](https://en.wikipedia.org/wiki/Industrial_internet_of_things) and [Industry 4.0 (I4.0)](https://en.wikipedia.org/wiki/Fourth_Industrial_Revolution) technologies into enterprise systems. My doctoral thesis, titled [Research of Industrial Internet of Things and Industry 4.0 in Enterprise Resource Planning](https://repozitorium.omikk.bme.hu/server/api/core/bitstreams/3c063b02-672e-45a9-a525-614c0ef7b92a/content), explored smart manufacturing, predictive analytics, and industrial cyber-physical systems, with significant implications for advancing IIoT and I4.0 domains.
...
I aim to contribute to a digitally integrated, sustainable, and human-centric industrial and built ecosystem, where data flows seamlessly across systems, decisions are informed by real-time insights, and technology serves both operational excellence and environmental stewardship.
